...
const emailTemplate = ({ code, title }) => {
    return `<!DOCTYPE html>
                ...
                <a href="${config_1.LINKED_IN}" style="text-decoration: none;"><span class="twit" style="padding:10px 9px;color:#fff;border-radius:50%;">
                ...
                <a href="${config_1.GITHUB}" style="text-decoration: none;"><span class="twit" style="padding:10px 9px;;color:#fff;border-radius:50%;">
