import { GITHUB, INSTAGRAM, LINKED_IN } from "../../../config/config"
...
export const emailTemplate = ({ code, title }: EmailTemplateParams): string => {
    return `<!DOCTYPE html>
                <html>
                <head>
                ...
                <a href="${LINKED_IN}" style="text-decoration: none;"><span class="twit" style="padding:10px 9px;color:#fff;border-radius:50%;">
